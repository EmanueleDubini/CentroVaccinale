...
public class CalcolaCodiceFiscale {
    ...
    public static String calcolaCf(String cognome, String nome, String sesso,
        ...
        return (codfisc.toString()).replaceAll("\u0000", "F");//prima di fare return esegue la verifica che non ci siano caratteri nulli nel cf generato, se ne trova uno lo elimina e mette la lettera F.
    ...
    /**
     * Prende la stringa che rappresenta il comune in input  e la sostituisce con il
     * corrispettivo codice erariale del comune.
     * I caratteri gestiti, e le relative sostituzioni, sono i seguenti:<p>
     *
